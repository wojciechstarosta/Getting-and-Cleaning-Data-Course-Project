...
setwd("H:/BOK/Rozwój/R programming/Course 3 Data cleaning/UCI HAR Dataset")
...
setwd("H:/BOK/Rozwój/R programming/Course 3 Data cleaning/UCI HAR Dataset/train")
...
#uploading test set
setwd("H:/BOK/Rozwój/R programming/Course 3 Data cleaning/UCI HAR Dataset/test")
